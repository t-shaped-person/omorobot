...
if ROBOT_MODEL == 'R2MINI':
    ...
    MAX_ANG_VEL = 1.0   # 1.0rad/s (57.3degree/s), wheel speed: 0.1m/s = 0.2/2*1.0
    STEP_LIN_VEL = 0.05 # 0.05m/s step
    STEP_ANG_VEL = 0.1  # 0.1rad/s (5.73degree/s)
else: # R2 etc
    MAX_LIN_VEL = 0.6   # 0.6m/s
    MAX_ANG_VEL = 1.0   # 1.0rad/s (57.3degree/s), wheel speed: 0.3m/s = 0.6/2*1.0
